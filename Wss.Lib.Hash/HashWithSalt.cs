...
namespace GABIZ.Base.Cryptography
{
    public class HashWithSalt
    {
                                         ...
                                         byte[] saltBytes)
        {
            ...
            // Convert result into a base64-encoded string.
            string hashValue = ByteArrayToString(hashWithSaltBytes);
        ...
        /// value is true; otherwise, the function returns false.
        /// </returns>
        public static bool VerifyHashHex(string plainText,
                                      string hashAlgorithm,
                                      string hashValue)
        {
            // Convert base64-encoded hash value into a byte array.
            byte[] hashWithSaltBytes = StringToByteArray(hashValue);
            ...
            // Compute a new hash string.
            string expectedHashString =
                        ComputeHashHex(plainText, hashAlgorithm, saltBytes);
        ...
        /// </summary>
        /// <param name="hex">Input hexa string</param>
