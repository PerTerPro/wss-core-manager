...
namespace GABIZ.Base.Cryptography
{
    public class CRC64
    {
        public static UInt64[] crc64_table = { 
        ...
        public static void Init_crc(UInt64 crc)
        {
            crc = 0xffffffffffffffff;
        }

        /* Finish a CRC calculation */
        public static void Fin_crc(UInt64 crc)
        {
            crc ^= 0xffffffffffffffff;
        }
        ...
        public static void Calc_crc(ref UInt64 crc, Byte[] pbData, uint len)
        {
